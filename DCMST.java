...
import datastructures2018.WeightedGraph.MST;
import datastructures2018.WeightedGraph.ShortestPathTree;
	...
	public static void main(String[] args) {
		...
		for (int j = 0; j < vertices; j++) {
			for (int i = 0; i < vertices; i++) {
				...
				if (r < p) {
					edgeList.add(new WeightedEdge(i, j, ((double) Math.random() * 100)));
				}
			}
		}

		WeightedGraph<Integer> graph = new WeightedGraph<>(verts, edgeList);
